<script lang="ts">
	...
	function togglePopupCarro() {
		$carrito.isCartOpen = !$carrito.isCartOpen;
	};
			...
			<svelte:fragment slot="trail">
				<div class="relative inline-block">
					...
					>
						<div>
							{#if $carrito.cartItemCountTotal != 0}
							<span class="badge-icon variant-filled-primary absolute -top-0 -right-0 z-10 text-white">{$carrito.cartItemCountTotal}</span>
							{/if}
